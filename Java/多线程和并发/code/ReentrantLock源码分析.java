...
public class ReentrantLock implements Lock, java.io.Serializable {
    ...
    /**
     * 尝试获取锁，这里使用的是非公平的方式获取的锁，因为这时一次尝试，如果获取不到的话，可能就有其他后续处理了
    ...
    /**
     * 带有时间的尝试获取锁，在规定时间内获取到锁，返回 true ，否则返回 false
    ...
    public final boolean hasQueuedThreads() {
        // 这里的是通过判断 AQS 队列中是否元元素
        return sync.hasQueuedThreads();
    }

    /**
     * 判断给定的 thread 是否在等待队列中
    ...
    /**
     * 判断给定的 Condition 中的队列中是否有正在等待的线程
    ...
    /**
     * 获取给定的 Condition 中正在等待的线程的 Thread
